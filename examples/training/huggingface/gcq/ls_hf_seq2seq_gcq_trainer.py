...
logger = logging.getLogger("lightseq_hf_seq2seq_trainer")

class LSSeq2SeqTrainer(Seq2SeqTrainer):
    """
    LSSeq2SeqTrainer supports GCQ (Gradient Communication Quantization) for distributed multi-machine training 
